...
const uiTranslations: { [key: string]: string } = {
  ...
  // Sidebar & App
  "Boshqaruv Tizimi v1.0": "Бошқарув Тизими v1.0",
  ...
  "Hujjatlarni boshqarish tizimi v1.0": "Ҳужжатларни бошқарув тизими v1.0",
